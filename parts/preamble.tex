\usepackage[left=0.70in,right=0.70in,top=0.60in,bottom=0.45in,nohead,includefoot]{geometry}
\usepackage{hyperref}
\usepackage{fancyhdr}
\usepackage{titlesec}
\usepackage{titling}
...
\newcommand{\CVNote}{CV compiled on {\today}, available at \href{\CVWebpageCV}{\CVWebpageCV}.}
